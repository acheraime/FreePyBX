...
static switch_status_t load_config(void)
{
	...
	switch_cache_db_test_reactive(dbh, "select count(ready_time) from agents", NULL, "alter table call_center_agents add ready_time integer not null default 0;"
	...
	switch_cache_db_test_reactive(dbh, "select count(no_answer_delay_time) from agents", NULL, "alter table call_center_agents add no_answer_delay_time integer not null default 0;");
